...
/*   Updated: 2025/07/23 14:29:29 by jrandet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

// static void	print_door(t_main *main, int idx_x, int idx_y, int color)
// {
// 	int	x;
// 	int	y;
// 	int	start_x;
...
// 	{
// 		x = start_x;
// 		while (x <= start_x / 5 + main->minimap.tile_size)
// 		{
// 			put_pixel_to_image(main, x, y, color);
// 			x++;
// 		}
// 		x = start_x + main->minimap.tile_size - start_x / 5;
