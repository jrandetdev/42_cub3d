...
/*   Updated: 2025/08/15 16:13:35 by hdougoud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	option_selected(t_main *main, int *menu, int option_selected, int *menu_section)
{
	main->interaction.keys.enter = 0;
	if (option_selected == 0)
		main->menu.option.show_minimap_grid = !main->menu.option.show_minimap_grid;
	else if (option_selected == 1)
		main->menu.option.fov = !main->menu.option.fov;
...
void	show_debug_menu(t_main *main, int *menu)
{
	...
	print_box(main, &param, main->menu.option.show_minimap_grid, "MINIMAP GRID");
	print_box(main, &param, main->menu.option.fov, "MINIMAP FOV");
