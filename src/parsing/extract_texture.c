...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/24 16:15:08 by jrandet           #+#    #+#             */
/*   Updated: 2025/06/24 17:09:32 by jrandet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (is_dir(xpm_file))
		return (exit_cub3d(main, 1), false);
	if (xmp_extension_is_valid(xpm_file, 4) == false)
		return (exit_cub3d(main, 1), false);
